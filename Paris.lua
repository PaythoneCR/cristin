...
local ban = LuaTele.getUser(paris)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(paris..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(paris.."Start:Bot") then
...
local CmdStart = '*\n𖥔 أهلآ بك في بوت '..(Redis:get(paris.."Name:Bot") or "كلير")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(paris.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
Redis:set(paris.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*𖥔 ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(paris.."zhrfa"..IdUser,"sendzh") 
