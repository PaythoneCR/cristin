...
ControllerAll = false
local ListSudos ={Sudo_Id,1001132193,1833610203,1554085475,1761050341,5076237918}  
...
--download('https://raw.githubusercontent.com/PaythoneCR/cristin/master/paris.lua','paris.lua')
...
local CmdStart = '*\n ❍︙ أهلآ بك في بوت '..(Redis:get(paris.."paris:Name:Bot") or "كريستين")..
